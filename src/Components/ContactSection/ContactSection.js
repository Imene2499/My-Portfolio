...
function ContactSection() {
    ...
    return (
        <div data-aos="fade-up" className="py-12 md:py-24 px-4 md:px-12 lg:px-24">
            ...
            <p className="text-DarkBlue font-[Raleway] font-semibold pt-4 md:pt-16 leading-10 pb-8 md:text-[1.2em] text-center">Don't hesitate to reach out to me if you like my work!
            </p>
