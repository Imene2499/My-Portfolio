...
function ExperienceSection() {
    ...
    return (
        <div className="pt-24 md:py-32 px-4 md:pl-12 lg:pl-24 text-DarkBlue">
            <h1 className="text-Yellow font-extrabold text-[3.5em] md:text-[4em] lg:text-[4.5em] font-[poppins] pb-12 md:pb-24">EXPERIENCE.</h1>
            <div className="flex justify-between items-center flex-col lg:flex-row pb-16 md:pb-28 px-4 md:px-16 lg:px-0">
            ...
            <div className="flex justify-between items-center flex-col lg:flex-row pb-16 md:pb-28 justify-end px-4 md:px-16 lg:px-0">
            ...
            <div className="flex justify-between items-center flex-col lg:flex-row px-4 md:px-16 lg:px-0">
