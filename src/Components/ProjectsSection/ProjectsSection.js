...
function ProjectsSection() {
    return (
        <div className="py-12 md:py-24 px-8 md:px-12 lg:px-24">
            ...
            <p className="text-DarkBlue font-[Raleway] font-medium leading-10 pb-12 text-[1.2em]">I mainly use <span className="font-bold">Github</span> to share and collaborate projects, you can check them out in my Github account below, also you can find
